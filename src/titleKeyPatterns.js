...
export const IDLE_TITLE_KEY_PATTERNS = [
  ...
  {
    name: "k-dot-types-k-dot-types",
    frames: [
      idleGroupPress([0, 1, 2, 3, 4]),
      pause(),
      idleGroupPress([6, 7, 8, 9, 10]),
      pause(),
      idleGroupPress([0, 1, 2, 3, 4]),
      pause(),
      idleGroupPress([6, 7, 8, 9, 10]),
...
export const ACTION_TITLE_KEY_PATTERNS = [
  ...
  },
  {
    name: "victory",
    frames: [
      ...pressSequence(TITLE_KEY_INDEXES.slice(0, 6)),
      press([7, 8], 1000),
      pause(),
      press([7, 8], 100),
      pause(),
  ...
  },
  {
    name: "game-over",
    frames: [
      ...pressSequence([...TITLE_KEY_INDEXES].reverse()),
      pause(),
      ...pressSequence([...TITLE_KEY_INDEXES].reverse()),
      pause(),
      ...pressSequence([...TITLE_KEY_INDEXES].reverse()),
      pause(),
      press(TITLE_KEY_INDEXES, 500),
      pause(),
